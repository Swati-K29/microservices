...
import com.practise.accounts.dto.ErrorResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Accounts - udemy course",
        description = "CRUD REST APIs udemy to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
